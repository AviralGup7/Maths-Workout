...
const makeStyles = (C: ReturnType<typeof useLegacyPalette>) => StyleSheet.create({
  ...
  skillPct: { fontSize: 13, fontFamily: 'Inter_700Bold' , fontVariant: ['tabular-nums']},
  ...
  summaryVal: { fontSize: 20, fontFamily: 'Inter_700Bold' , fontVariant: ['tabular-nums']},
  ...
  classBoxNumText: { fontSize: 16, fontFamily: 'Inter_700Bold' , fontVariant: ['tabular-nums']},
  classBoxLabel: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: C.foreground },
  classBoxPct: { fontSize: 16, fontFamily: 'Inter_700Bold' , fontVariant: ['tabular-nums']},
