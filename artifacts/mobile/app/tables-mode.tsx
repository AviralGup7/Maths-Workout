...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 12, fontFamily: 'Inter_400Regular', color: C.mutedForeground, textAlign: 'center', marginTop: 2 },
  scroll: { paddingHorizontal: 16, paddingTop: 16 },
  legend: { flexDirection: 'row', flexWrap: 'wrap', gap: 14, marginBottom: 18 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  legendDot: { width: 8, height: 8, borderRadius: 4 },
  legendText: { fontSize: 12, fontFamily: 'Inter_400Regular', color: C.mutedForeground },
  ...
  tableMultiply: { fontSize: 11, fontFamily: 'Inter_400Regular', color: C.mutedForeground },
  tableBest: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3 },
  tableBestText: { fontSize: 11, fontFamily: 'Inter_600SemiBold' },
