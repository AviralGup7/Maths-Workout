...
const makeStyles = (C: ReturnType<typeof useLegacyPalette>) => StyleSheet.create({
  ...
  levelText: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: C.mutedForeground , fontVariant: ['tabular-nums']},
  ...
  scoreBig: { fontSize: 50, fontFamily: 'Inter_700Bold', lineHeight: 54 , fontVariant: ['tabular-nums']},
