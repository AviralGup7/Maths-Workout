...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 11.5, fontFamily: 'Inter_400Regular', color: C.mutedForeground, textAlign: 'center' },
  ...
  badgeText: { fontSize: 12.5, fontFamily: 'Inter_700Bold' },
  ...
  diffTitle: { fontSize: 12.5, fontFamily: 'Inter_700Bold', color: C.foreground },
  diffRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  diffCat: { flex: 1.3, fontSize: 12, fontFamily: 'Inter_500Medium', color: C.mutedForeground },
  diffCell: { flex: 1, alignItems: 'center' },
  diffCellLabel: { fontSize: 9.5, fontFamily: 'Inter_600SemiBold' },
  diffCellValue: { fontSize: 12, fontFamily: 'Inter_700Bold', color: C.foreground },
  continueBtn: {
